...
これをやり始めると、じゃあ全身で筋肉にあわせてトポロジを歪める対応をやるのか？という疑問が湧く。
...
*しぼみはモデリングの段階で解決する問題ではない*のです。

量産する前提のモデルでトポロジをひねるのは絶対にやめた方が良い。  
自主制作でこだわる分には好きにしたらいいと思う。

ただ、アナトミーに忠実なトポロジにすることこそが正みたいにTipsを広めるのはやめていただきたい。学生が勘違いするし、勘違いしている学生を矯正するのも大変なので。

これだけは言っておく。  
*アナトミーに忠実なトポロジが、製品として正しいトポロジではない。*
